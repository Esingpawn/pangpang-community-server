...
const servers=[{id:'pangpang-3x',name:'失控进化 · 3X 公平社区服',description:'3x资源 / 矿多 / 18:00—24:00领地突袭',status:'online',statusLabel:'运营中',players:'128 / 150',ping:32,openedAt:'2026.09.20'},{id:'build-lab',name:'胖胖 · 建造实验室',description:'建筑挑战 / 电路共创 / 和平模式',status:'preparing',statusLabel:'筹备中',players:'—',ping:null,openedAt:'即将开放'},{id:'weekend-arena',name:'胖胖 · 周末竞技场',description:'限时 PvP / 统一装备 / 社区比赛',status:'event',statusLabel:'活动服',players:'—',ping:null,openedAt:'周六 20:00'}];
